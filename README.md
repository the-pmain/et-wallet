...
и токенов ERC-20, отслеживание судьбы отправленных транзакций,
ускорение и отмена застрявших, портфель с оценкой, подключение приложений
...
**Пользоваться с настоящими средствами пока рано.** Коллекционные
токены не поддержаны вовсе: кошелёк не читает, какие предметы
принадлежат адресу, и отправлять их нечем. Нет списка проверенных
контрактов и управления выданными разрешениями.
...
| Проверка | Значение |
| --- | --- |
| Модульных и интеграционных тестов | 1547 |
