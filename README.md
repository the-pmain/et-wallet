...
**Пользоваться с настоящими средствами пока рано.** Не реализована
отправка токенов ERC-20 и NFT; нет списка проверенных контрактов
и управления выданными разрешениями.
...
| Проверка | Значение |
| --- | --- |
| Модульных и интеграционных тестов | 1519 |
