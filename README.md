...
**Кошелёк ещё нельзя использовать с настоящими средствами.** Причина
одна и техническая: хранилище работает в памяти, и перезагрузка вкладки
стирает кошелёк. Не реализованы также отслеживание статуса отправленной
транзакции и отправка токенов.
...
| Проверка | Значение |
| --- | --- |
| Модульных и интеграционных тестов | 1425 |
| Сквозных тестов (Chromium) | 16 |
