...
describe('TransferAssetSelect', () => {
  ...
  it('passes the chosen coin and closes the list', async () => {
    ...
    render(<TransferAssetSelect id="asset" value={defaultTransferAsset().id} onChange={onChange} />)
  ...
  it('marks the selected asset with a check', async () => {
    ...
    render(<TransferAssetSelect id="asset" value={usdc?.id ?? ''} onChange={() => undefined} />)
