 ...
 * неотличимые на глаз.
 *
 * ЗАЧЕМ. Сравнение имён побайтово обходится одной буквой: `Ethereum`
 * с кириллической `е` не совпадает с латинским ни в одном байте, а
 * выглядит точно так же. Пользователь видит привычное имя в шапке
 * кошелька и подписывает перевод, считая его отправкой в основную сеть.
 *
