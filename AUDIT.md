...
| Конфигурации сетей, RPC-адреса, настройки | `settings`, `networks` | **открыто** |
...
| Интернационализация | Частично: переведены вход, панель и навигация; экраны операций — нет (A-85) |
